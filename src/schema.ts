...
//   extends Omit<IDBDatabase, 'createObjectStore' | 'deleteObjectStore' | 'transaction' | 'objectStoreNames'> {
//   // /**
...
// > extends Omit<IDBTransaction, 'db' | 'objectStore' | 'objectStoreNames'> {
//   /**
...
// > extends Omit<IDBObjectStore,'transaction' | 'add' | 'clear' | 'count' | 'createIndex' | 'delete' | 'get' | 'getAll' | 'getAllKeys' | 'getKey' | 'index' | 'openCursor' | 'openKeyCursor' | 'put' | 'indexNames'> {
//   // /**
...
// > extends Omit<IDBIndex, 'objectStore' | 'count' | 'get' | 'getAll' | 'getAllKeys' | 'getKey' | 'openCursor' | 'openKeyCursor'> {
//   /**
...
//   IndexName extends IndexNames<DBTypes, StoreName> | unknown = unknown
// >
//   extends Omit<IDBPCursorWithValue<DBTypes, TxStores, StoreName, IndexName>, 'advance' | 'continue' | 'continuePrimaryKey'> {
//   /**
//    * Advances the cursor a given number of records.
//    */
//   advance<T>(this: T, count: number): void;
